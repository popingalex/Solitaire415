...
public class Card {
	...
	/**
	 * return if sufCard is 1 bigger than preCard 
	 * @param preCard
	 * @param sufCard
	 * @return
	 */
	public static boolean isNext(Card preCard, Card sufCard) {
		return preCard.getValue().compareTo(sufCard.getValue())==-1;
	}

	public static boolean isSameColour(Card cardA, Card cardB) {
		return cardA.getColour() == cardB.getColour();
	}

    public static boolean isSameSuit(Card cardA, Card cardB) {
